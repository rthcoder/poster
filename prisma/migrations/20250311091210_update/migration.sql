/*
  ...
  - You are about to drop the column `int` on the `user_role` table. All the data in the column will be lost.
  - You are about to drop the `company` table. If the table is not empty, all the data it contains will be lost.
  - Made the column `company_id` on table `branch` required. This step will fail if there are existing NULL values in that column.
...
-- DropIndex
DROP INDEX "user_role_int_key";

-- AlterTable
ALTER TABLE "branch" ALTER COLUMN "company_id" SET NOT NULL;

-- AlterTable
ALTER TABLE "user_role" DROP COLUMN "int";
